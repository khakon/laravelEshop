            ...
            <div class="panel-body">
                {!! Form::open(['route' => 'plans.swap', 'class' => 'form-horizontal']) !!}
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <p class="form-control-static">{{ Auth::user()->stripe_plan }}</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <p class="form-control-static">
                                ...
                                <small>{{ Carbon\Carbon::createFromTimestamp($user->upcomingInvoice()->next_payment_attempt)->toDayDateTimeString() }}</small>
                            </p>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <table class="table">
                    @foreach ($user->invoices() as $invoice)
                        <tr>
                            <td>Paid {{ $invoice->dollars() }} on <small>{{ $invoice->dateString() }}</small></td>
                            <td>
